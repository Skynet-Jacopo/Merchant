...
public class WorkerRegisterActivity3 extends AutoLayoutActivity {
    ...
    ImageView   mIvHandleIdentityCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_register3);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_business_license_pic:
                mActivityUtils.showToast("手持身份证");
                getHandleIdentityCard();
                break;
    ...
    private void getHandleIdentityCard() {
    ...
    private GalleryFinal.OnHanlderResultCallback getHandleIdentityPicCallBack = new GalleryFinal
...
//                    mIvHandleIdentityCard);
            mIvHandleIdentityCard.setBackgroundColor(Color.red(R.color.red));
            mIvHandleIdentityCard.setImageBitmap(BitmapFactory.decodeFile(resultList.get(0).getPhotoPath()));
        }
